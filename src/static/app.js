              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button type="button" class="remove-participant" data-activity="${escapeHtml(name)}" data-email="${escapeHtml(participant)}" aria-label="Unregister ${escapeHtml(participant)}" title="Unregister participant">&#10005;</button>
                  </li>`
              )
              .join("")
